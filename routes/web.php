...
Route::middleware(['role:landlord'])->prefix('landlord')->name('landlord.')->group(function () {
    ...
    Route::controller(ChatController::class)->group(function () {
        ...
        Route::post('/messages/{id}/read', 'markAsRead')->name('chat.mark-read')->middleware('throttle:30,1');
        Route::post('/messages/{id}/ticket-status', 'updateTicketStatus')->name('chat.ticket-status')->middleware('throttle:30,1');

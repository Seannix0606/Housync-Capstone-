...
<head>
    ...
    <style>
        ...
        /* ========== Universal Light-Surface Overrides ========== */
        ...
        body.dark-mode [style*="color:#333"] { color: #e2e8f0 !important; }
...
<div class="dashboard-container" id="dashboardContainer">
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <span class="saas-logo-mark" aria-hidden="true"><i class="fas fa-tools"></i></span>
    ...
    <main class="main-content">
        <div class="saas-topbar">
            <div class="saas-search-wrap">
                ...
                <input type="search" class="saas-search-input" placeholder="Search tasks, messages…" aria-label="Search">
            </div>
